...
var GModalApproval = function(){
 ...
 var barra = '<div id="xxx_texto">'+configuracao.barra.texto+'</div>';
 barra += '<div id="xxx_botoes">';
 if(configuracao.barra.botao_configurar){barra += '<div id="xxx_botoes-configurar" class="xxx_botoes-botao">'+configuracao.barra.botao_configurar+'</div>';}
 barra += '<div id="xxx_botoes-confirmar" class="xxx_botoes-botao">'+configuracao.barra.botao_aceitar+'</div>';
 barra += "</div>";
 if(configuracao.barra.fechar){barra += '<div id="xxx_fechar"></div>';}
 
 var g_lgpd = document.createElement("div");
 g_lgpd.id = 'xxx';
 g_lgpd.className = 'posicionar xxx-cor_'+configuracao.barra.cor+' '+(configuracao.barra.botao_configurar ? 'botoes' :'botao')+' '+configuracao.barra.classe;
 ...
 var g_lgpd = document.getElementById("xxx_editar");
 if(g_lgpd == null){
 
 var g_lgpd = document.createElement("div");
 g_lgpd.id = 'xxx_editar';
 g_lgpd.className = 'posicionar gtt-direita xxx-cor_'+configuracao.barra.cor+' '+configuracao.barra.classe;
 ...
 GLoading.carregar({'ativar':false});
 var lgpd = document.getElementById("xxx");
 if(lgpd == null){lgpd = document.getElementById("xxx_editar");}
 ...
 posicionar :function(){
 var g_lgpd = document.getElementById("xxx");
 if(g_lgpd == null){g_lgpd = document.getElementById("xxx_editar");}
 if(g_lgpd){
 ...
 var botao_editar = document.getElementById("xxx_editar");
 if(botao_editar){
 botao_editar.removeEventListener("click",function(){GModalApproval.modal(configuracao);},false);
 botao_editar.addEventListener("click", function(){GModalApproval.modal(configuracao);});
}
 
 var botao_configurar = document.getElementById("xxx_botoes-configurar");
 if(botao_configurar){
 botao_configurar.removeEventListener("click",function(){GModalApproval.modal(configuracao);},false);
 botao_configurar.addEventListener("click", function(){GModalApproval.modal(configuracao);});
}
 
 var botao_confirmar = document.getElementById("xxx_botoes-confirmar");
 if(botao_confirmar){
 botao_confirmar.removeEventListener("click",function(){GModalApproval.confirmarTodos(configuracao);},false);
 botao_confirmar.addEventListener("click", function(){GModalApproval.confirmarTodos(configuracao);});
}
 
 var botao_fechar = document.getElementById("xxx_fechar");
 if(botao_fechar){
...
GObserver.iniciar();
 ...
 elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_168834791762356253':{'desktop':3.90625, 'mobile':0}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc2c7':{'fs':'33', 'lh':'1.2'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc2c7':{'desktop':46.0224, 'mobile':25.5455}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc471':{'fs':'18', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc471':{'desktop':296.59, 'mobile':163}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc4b8':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc4b8':{'desktop':491.611, 'mobile':774.057}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc4e0':{'desktop':214.014, 'mobile':334.188}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc50b':{'desktop':218.417, 'mobile':326.6}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccd69':{'desktop':301.257, 'mobile':163}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccf3e':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccf3e':{'desktop':594.613, 'mobile':583.35}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc548':{'fs':'38', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc548':{'desktop':36.4, 'mobile':27}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc56e':{'fs':'18', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc56e':{'desktop':133.792, 'mobile':157.95}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_78073':{'desktop':218.5, 'mobile':436.95}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_94359':{'desktop':303.792, 'mobile':311.95}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc598':{'desktop':-9.58334, 'mobile':40}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc5cb':{'desktop':82.8, 'mobile':189.489}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc61a':{'fs':'20', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc61a':{'desktop':118.4, 'mobile':286.489}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc9c5':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc9c5':{'desktop':305.648, 'mobile':537.057}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccef2_m':{'desktop':-158.125, 'mobile':22.0556}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccf93':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccf93':{'desktop':396, 'mobile':531}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc90e':{'desktop':10.352, 'mobile':-0.000103394}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc94a':{'fs':'19', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc94a':{'desktop':165, 'mobile':409.739}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cc98c':{'fs':'40', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cc98c':{'desktop':18.875, 'mobile':226.182}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cca04':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cca04':{'desktop':426.375, 'mobile':708.818}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccff3_m':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccff3_m':{'desktop':252, 'mobile':751.375}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cca44':{'fs':'16', 'lh':''}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cca44':{'desktop':136.682, 'mobile':174.182}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccabb':{'fs':'40', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccabb':{'desktop':22.0909, 'mobile':40}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccff3_d':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccff3_d':{'desktop':252, 'mobile':751.375}});blocos_posicao = Object.assign(blocos_posicao,{'b_154267_1_1671146040639baa38cc2c1':{'desktop':504, 'mobile':652.514}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccaf6':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccaf6':{'desktop':20.375, 'mobile':17.9997}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccef2_d':{'desktop':-158.125, 'mobile':22.0556}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38cd05b':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cd05b':{'desktop':45, 'mobile':18}});elementos_css = Object.assign(elementos_css,{'e_154267_1_1671146040639baa38ccc86':{'fs':'16', 'lh':'1.1'}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccc86':{'desktop':14.341, 'mobile':142.542}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccdad':{'desktop':46.9319, 'mobile':178.333}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccdf2':{'desktop':82.591, 'mobile':227.361}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38cce5a':{'desktop':117.125, 'mobile':265.389}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_1671146040639baa38ccea0':{'desktop':151.625, 'mobile':299.417}});elementos_posicao = Object.assign(elementos_posicao,{'e_154267_1_168834793560604384':{'desktop':14.3281, 'mobile':-1}});function InserirScriptsInline(){elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38cc4b8':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38ccf3e':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38cc9c5':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38ccf93':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38cca04':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38ccff3_m':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38ccff3_d':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38ccaf6':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_154267_1_1671146040639baa38cd05b':{'conteudo':function(){fbq('track', 'Contact');}}});function getCrawlerInterno(){
if(typeof navigator.userAgentData != 'undefined'){let retorno = false;navigator.userAgentData.brands.forEach(function (item){if(item.brand.toLowerCase() == 'lighthouse' || item.brand.toLowerCase() == 'gtmetrix'){retorno = true;}});if(!retorno){retorno = window.navigator.userAgent.indexOf('GTmetrix') !== -1 ? true :false;}return retorno;}
else{
if(window.navigator.userAgent.indexOf('GTmetrix') !== -1 || window.navigator.userAgent.indexOf('Lighthouse') !== -1){return true;}
else{return false;}
...
setTimeout(function(){
var c = '',data = new Date();function FormatarDigitosData(valor, digitos){if (valor.toString().length < digitos){ return (new Array(digitos - valor.toString().length+1).join('0'))+valor;}else{return valor;}}if(document.cookie != ''){var split = document.cookie.split(';');for(var i = 0;i < split.length;i++){var conteudo = split[i].split('=');if(conteudo[0].indexOf('_fbp') !== -1){c = conteudo[1];}}}var g ={'v':1,'a':'pageview','s':'SUzVqYjIwdVluSXZZMkZ5Wlc1amFXRXRaWE4wWlc1a2FXUmhMV1pwWlhNb2lUZFVpcE8EdZUjliSzlWV25sR1RhSFIwY0hNNkx5OTNkM2N1WkdWallYTjBjbTloWjI5emRHbHVh','d':data.getFullYear()+'-'+FormatarDigitosData(data.getMonth()+1,2)+'-'+FormatarDigitosData(data.getDate(),2)+' '+FormatarDigitosData(data.getHours(),2)+':'+FormatarDigitosData(data.getMinutes(),2)+':'+FormatarDigitosData(data.getSeconds(),2),'e':eid,'i':'','c':c};var scripts = document.createElement('script');
