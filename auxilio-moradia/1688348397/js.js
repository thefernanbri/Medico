...
},
{
 ...
 'dominio':'.decastroagostini.com.br',
...
var GModalApproval = function(){
 ...
 if (configuracao.barra.hasOwnProperty('botao_aceitar') == false){configuracao.barra.botao_aceitar = '';}
 if (configuracao.barra.hasOwnProperty('texto') == false){configuracao.barra.texto = '';}
 
 var barra = '<div id="xxxxx_">'+configuracao.barra.texto+'</div>';
 barra += '<div id="xxxxx_botoes">';
 if(configuracao.barra.botao_configurar){barra += '<div id="xxxxx_botoes-configurar" class="xxxxx_botoes-botao">'+configuracao.barra.botao_configurar+'</div>';}
 barra += '<div id="xxxxx_botoes-confirmar" class="xxxxx_botoes-botao">'+configuracao.barra.botao_aceitar+'</div>';
 barra += "</div>";
 if(configuracao.barra.fechar){barra += '<div id="xxxxx_fechar"></div>';}
 
 var g_lgpd = document.createElement("div");
 g_lgpd.id = 'xxxxx';
 g_lgpd.className = 'posicionar xxxxx-cor_'+configuracao.barra.cor+' '+(configuracao.barra.botao_configurar ? 'botoes' :'botao')+' '+configuracao.barra.classe;
 ...
 var g_lgpd = document.getElementById("xxxxx_editar");
 if(g_lgpd == null){
 
 var g_lgpd = document.createElement("div");
 g_lgpd.id = 'xxxxx_editar';
 g_lgpd.className = 'posicionar gtt-direita xxxxx-cor_'+configuracao.barra.cor+' '+configuracao.barra.classe;
 ...
 GLoading.carregar({'ativar':false});
 var lgpd = document.getElementById("xxxxx");
 if(lgpd == null){lgpd = document.getElementById("xxxxx_editar");}
 ...
 posicionar :function(){
 var g_lgpd = document.getElementById("xxxxx");
 if(g_lgpd == null){g_lgpd = document.getElementById("xxxxx_editar");}
 if(g_lgpd){
 ...
 var botao_editar = document.getElementById("xxxxx_editar");
 if(botao_editar){
 botao_editar.removeEventListener("click",function(){GModalApproval.modal(configuracao);},false);
 botao_editar.addEventListener("click", function(){GModalApproval.modal(configuracao);});
}
 
 var botao_configurar = document.getElementById("xxxxx_botoes-configurar");
 if(botao_configurar){
 botao_configurar.removeEventListener("click",function(){GModalApproval.modal(configuracao);},false);
 botao_configurar.addEventListener("click", function(){GModalApproval.modal(configuracao);});
}
 
 var botao_confirmar = document.getElementById("xxxxx_botoes-confirmar");
 if(botao_confirmar){
 botao_confirmar.removeEventListener("click",function(){GModalApproval.confirmarTodos(configuracao);},false);
 botao_confirmar.addEventListener("click", function(){GModalApproval.confirmarTodos(configuracao);});
}
 
 var botao_fechar = document.getElementById("xxxxx_fechar");
 if(botao_fechar){
 ...
 var elemento = document.getElementById('xxxxx');
 if (elemento != null){
...
GObserver.iniciar();
 ...
 elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_168834807877150035':{'desktop':0, 'mobile':0}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3331902':{'fs':'27', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331902':{'desktop':46.0224, 'mobile':25.5455}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3331d04':{'fs':'20', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331d04':{'desktop':271.42, 'mobile':255.438}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3331d59':{'fs':'18', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331d59':{'desktop':386.013, 'mobile':456.888}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3331da7':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331da7':{'desktop':575.612, 'mobile':774.057}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331df8':{'desktop':142.013, 'mobile':866.875}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331e51':{'desktop':149.424, 'mobile':859.275}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33334aa':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33334aa':{'desktop':594.613, 'mobile':1116.05}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3331ea2':{'fs':'21', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331ea2':{'desktop':35.4, 'mobile':27}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3331f70':{'fs':'18', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331f70':{'desktop':188.8, 'mobile':237.975}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3331fed':{'desktop':20.45, 'mobile':40}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33320f7':{'fs':'20', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33320f7':{'desktop':118.4, 'mobile':500.487}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33328cb':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33328cb':{'desktop':305.648, 'mobile':537.057}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3333409_m':{'desktop':-158.125, 'mobile':186.05}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3333563':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3333563':{'desktop':396, 'mobile':745}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33321c3':{'fs':'37', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33321c3':{'desktop':25.6, 'mobile':24}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332225':{'desktop':134.925, 'mobile':151.58}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33322e8':{'fs':'23', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33322e8':{'desktop':150.525, 'mobile':164.75}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333234d':{'desktop':199.35, 'mobile':365.159}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33323b5':{'fs':'23', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33323b5':{'desktop':211.675, 'mobile':380.557}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33324bc':{'desktop':252.5, 'mobile':565.193}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f333252d':{'fs':'23', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333252d':{'desktop':268.1, 'mobile':580.795}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332592':{'desktop':252.5, 'mobile':293.557}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332621':{'desktop':308.275, 'mobile':514.466}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333268b':{'desktop':333.5, 'mobile':1639.91}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33326eb':{'desktop':389.771, 'mobile':1690.91}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333274d':{'desktop':16.725, 'mobile':-0.000103394}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33327d3':{'fs':'19', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33327d3':{'desktop':165, 'mobile':409.739}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3332853':{'fs':'40', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332853':{'desktop':18.875, 'mobile':226.182}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3332951':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332951':{'desktop':386.375, 'mobile':708.818}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f333360f_m':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333360f_m':{'desktop':252, 'mobile':813.375}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f33329fc':{'fs':'16', 'lh':''}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33329fc':{'desktop':136.682, 'mobile':174.182}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3332af4':{'fs':'40', 'lh':'1.4'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332af4':{'desktop':22.0909, 'mobile':40}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f333360f_d':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333360f_d':{'desktop':252, 'mobile':813.375}});blocos_posicao = Object.assign(blocos_posicao,{'b_144864_1_166863237163754f33318f6':{'desktop':439, 'mobile':590.513}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3332b77':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332b77':{'desktop':20.375, 'mobile':17.9997}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3333409_d':{'desktop':-158.125, 'mobile':186.05}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3333718':{'fs':'18', 'lh':'1.3'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3333718':{'desktop':45, 'mobile':18}});elementos_css = Object.assign(elementos_css,{'e_144864_1_166863237163754f3332f06':{'fs':'16', 'lh':'1.1'}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f3332f06':{'desktop':14.341, 'mobile':142.542}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333317c':{'desktop':46.9319, 'mobile':178.333}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333320e':{'desktop':82.591, 'mobile':227.361}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f33332b8':{'desktop':117.125, 'mobile':265.389}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_166863237163754f333336a':{'desktop':151.625, 'mobile':299.417}});elementos_posicao = Object.assign(elementos_posicao,{'e_144864_1_168834809230413758':{'desktop':9.5, 'mobile':6.98438}});function InserirScriptsInline(){elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f3331da7':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f33334aa':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f33328cb':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f3333563':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f3332951':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f333360f_m':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f333360f_d':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f3332b77':{'conteudo':function(){fbq('track', 'Contact');}}});elementos_botoes_evento = Object.assign(elementos_botoes_evento,{'e_144864_1_166863237163754f3333718':{'conteudo':function(){fbq('track', 'Contact');}}});function getCrawlerInterno(){
if(typeof navigator.userAgentData != 'undefined'){let retorno = false;navigator.userAgentData.brands.forEach(function (item){if(item.brand.toLowerCase() == 'lighthouse' || item.brand.toLowerCase() == 'gtmetrix'){retorno = true;}});if(!retorno){retorno = window.navigator.userAgent.indexOf('GTmetrix') !== -1 ? true :false;}return retorno;}
else{
if(window.navigator.userAgent.indexOf('GTmetrix') !== -1 || window.navigator.userAgent.indexOf('Lighthouse') !== -1){return true;}
else{return false;}
...
!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod? n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window, document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','671740104393569');fbq('track','PageView',{},{eventID:eid});
...
setTimeout(function(){
var c = '',data = new Date();function FormatarDigitosData(valor, digitos){if (valor.toString().length < digitos){ return (new Array(digitos - valor.toString().length+1).join('0'))+valor;}else{return valor;}}if(document.cookie != ''){var split = document.cookie.split(';');for(var i = 0;i < split.length;i++){var conteudo = split[i].split('=');if(conteudo[0].indexOf('_fbp') !== -1){c = conteudo[1];}}}var g ={'v':1,'a':'pageview','s':'emRHbHVhUzVqYjIwdVluSXZZWFY0YVd4cGJ5MXRiM0poWkdsaG9aaTRwWDU0ZDM5ZHhIc2N1MVBkQ1ZhSFIwY0hNNkx5OTNkM2N1WkdWallYTjBjbTloWjI5','d':data.getFullYear()+'-'+FormatarDigitosData(data.getMonth()+1,2)+'-'+FormatarDigitosData(data.getDate(),2)+' '+FormatarDigitosData(data.getHours(),2)+':'+FormatarDigitosData(data.getMinutes(),2)+':'+FormatarDigitosData(data.getSeconds(),2),'e':eid,'i':'','c':c};var scripts = document.createElement('script');
